...
class SurvLoopServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__.'/Controllers/Overwrite/Authenticate.php' => base_path('app/Http/Middleware/Authenticate.php'),
            __DIR__.'/Controllers/Overwrite/routes-api.php'   => base_path('routes/api.php'),
