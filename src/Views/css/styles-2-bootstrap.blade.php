...
input[type="submit"].btn-info.btn-lg:hover, input[type="submit"].btn-info.btn-sm:hover {
...
input[type="submit"].btn-secondary.btn-lg:hover, input[type="submit"].btn-secondary.btn-sm:hover {
    color: {!! $css["color-main-faint"] !!};
    background: {!! $css["color-main-on"] !!};
    border: 1px {!! $css["color-main-faint"] !!} solid;
}
...
input[type="submit"].btn-danger.btn-lg:hover, input[type="submit"].btn-danger.btn-sm:hover {
