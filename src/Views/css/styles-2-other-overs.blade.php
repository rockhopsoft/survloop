...
.pagination>li>a:hover, .pagination>li>span:hover, .pagination>li>a:focus, .pagination>li>span:focus { color: {!! $css["color-main-bg"] !!}; background-color: {!! $css["color-main-on"] !!}; border-color: {!! $css["color-main-on"] !!} } 
.pagination>.active>a, .pagination>.active>span, .pagination>.active>a:hover, .pagination>.active>span:hover, .pagination>.active>a:focus, .pagination>.active>span:focus { z-index: 2; color: {!! $css["color-main-bg"] !!}; background-color: {!! $css["color-main-on"] !!}; border-color: {!! $css["color-main-on"] !!}; cursor: default } 
