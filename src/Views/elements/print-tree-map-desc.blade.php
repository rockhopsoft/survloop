<!-- resources/views/vendor/survloop/elements/print-tree-map-desc.blade.php -->
<p>This document shows all questions asked in this user survey. 
...
The right side of this tree shows where the user's responses will be stored in the database design.</p>