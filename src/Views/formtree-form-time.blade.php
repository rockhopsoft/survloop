...
<div class="timeWrap f26 disIn"><nobr>
    <select name="n{{ $nID }}fldHr" id="n{{ $nID }}fldHrID" data-nid="{{ $nID }}" 
        class="timeDrop form-control form-control-lg disIn mR5 @if (isset($xtraClass)) {{ $xtraClass }} @endif "
        {!! $GLOBALS["SL"]->tabInd() !!}>
    ...
    @endfor
        ...
        class="timeDrop form-control form-control-lg disIn mL5 mR5 @if (isset($xtraClass)) {{ $xtraClass }} @endif "
        {!! $GLOBALS["SL"]->tabInd() !!}>
    ...
    @endfor
        ...
        class="timeDrop form-control form-control-lg disIn mL5 @if (isset($xtraClass)) {{ $xtraClass }} @endif "
        {!! $GLOBALS["SL"]->tabInd() !!}>
