...
<i class="gry9 mL20 fPerc66">Don't worry, you can keep tweaking your entire database design forever.</i></p>
</center></div>
...
<center><input type="submit" class="btn btn-lg btn-primary mT20 f32" value="Create Database"></center>
