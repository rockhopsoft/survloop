...
<div class="row">
    ...
    <div class="col-md-6 pT20 taR">
        <a href="/dashboard/email/-3" class="btn btn-default">Create New Auto-Email</a>
...
@forelse ($emailList as $i => $email)
    <div class="row pT10 pB10 f18 @if ($i%2 == 0) row2 @endif ">
        <div class="col-md-4">
            <a href="/dashboard/email/{{ $email->ComEmailID }}"
                ><i class="fa fa-pencil fa-flip-horizontal mR10" aria-hidden="true"></i></a>
            {{ $email->ComEmailType }} 
            <br />
