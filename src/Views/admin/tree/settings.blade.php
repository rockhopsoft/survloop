...
<div class="row">
    <div class="col-7">
        ...
        <div class="slCard nodeWrap">
            ...
            <h4 class="m0">{{ $GLOBALS['SL']->treeRow->TreeType }} Name</h4>
            ...
            <div class="mB20 mT10 w100"><label class="w100">
            <h4 class="m0 disIn">{{ $GLOBALS['SL']->treeRow->TreeType }} URL</h4>
            ...
            <div class="mB20 mT10 w100"><label class="w100">
            <h4 class="m0 slGreenDark">{{ $GLOBALS['SL']->treeRow->TreeType }} Core Database Table</h4>
            ...
            <h4>{{ $GLOBALS['SL']->treeRow->TreeType }} Options</h4>
            <div class="row">
                <div class="col-6">
...
@else
        <div class="slCard nodeWrap">
            ...
            @for ($i = 0; $i < 20; $i++)
                <div id="proTipWrap{{ $i }}" class="disNon mB5"><div class="row">
                    <div class="col-10">
                        ...
                        <input type="text" class="form-control w100 ntrStp slTab" autocomplete="off"
                            name="proTipImg{{ $i }}" id="proTipImg{{ $i }}ID" {!! $GLOBALS["SL"]->tabInd() !!}
                            value="{{ ((isset($GLOBALS['SL']->proTipsImg[$i])) ? $GLOBALS['SL']->proTipsImg[$i] : '') 
                            }}">
                    </div>
                </div></div>
            @endfor
