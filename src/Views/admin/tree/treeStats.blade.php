...
<div class="p10">
@if ($isAll)
    <a class="btn btn-lg btn-default mR10" href="/dashboard/tree-{{ $GLOBALS['SL']->treeID }}/stats"
        ><i class="fa fa-expand fa-flip-horizontal"></i> Collapse All Nodes</a>
@else
    <a class="btn btn-lg btn-default mR10" href="/dashboard/tree-{{ $GLOBALS['SL']->treeID }}/stats?all=1"
