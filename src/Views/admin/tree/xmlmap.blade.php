...
<div class="row pT20 pB20">
    ...
    <div class="col-md-4">
        ...
        <a href="/xml-schema" target="_blank"><h2><i class="fa fa-file-code-o" aria-hidden="true"></i> XML Schema</h2></a>
        
    </div>
    <div class="col-md-4">

        <a href="/xml-example" target="_blank"><h2><i class="fa fa-file-code-o" aria-hidden="true"></i> XML Example</h2></a>
...
<div class="row">
    ...
    <div class="col-md-4">
        <iframe src="/xml-schema" class="w100" style="height: 1000px;"></iframe>
    </div>
    <div class="col-md-4">
        <iframe src="/xml-example" class="w100" style="height: 1000px;"></iframe>
    </div>
</div>
