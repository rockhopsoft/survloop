        ...
        <div id="hasPageOpts" class="nFld @if ($node->isPage()) disBlo @else disNon @endif "><div class="row">
            ...
            @if ($GLOBALS['SL']->treeRow->TreeType == 'Page')
                ...
                <label class="disBlo mT20">
                    ...
                    onClick="chkPageForTree();">
                    <i class="fa fa-list-alt mL10 mR5" aria-hidden="true"></i> Survey Report
                </label>
                <label class="disBlo mT20">
                    <input type="checkbox" name="searchPage" id="searchPageID" value="31" 
                    @if ($GLOBALS['SL']->treeRow->TreeOpts%31 == 0) CHECKED @endif autocomplete="off"
                    onClick="chkPageForTree();">
                    <i class="fa fa-search mL10 mR5" aria-hidden="true"></i> Survey Search Results
                </label>
