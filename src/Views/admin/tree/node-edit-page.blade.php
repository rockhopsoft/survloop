            ...
            <div class="row">
                ...
                @if ($GLOBALS['SL']->treeRow->TreeType == 'Page')
                    <label class="disBlo mT20">
                        ...
                        @if ($GLOBALS['SL']->treeRow->TreeOpts%3 == 0) CHECKED @endif autocomplete="off" class="mR5">
                        <i class="fa fa-eye mR5" aria-hidden="true"></i> Admin-Only Page
                    </label>
                    <label class="disBlo mT20">
                        <input type="checkbox" name="staffPage" id="staffPageID" value="43" 
                        @if ($GLOBALS['SL']->treeRow->TreeOpts%43 == 0) CHECKED @endif autocomplete="off" class="mR5">
                    ...
                    @if ($GLOBALS["SL"]->sysHas('partners'))
                        <label class="disBlo mT20">
                            ...
                            @if ($GLOBALS['SL']->treeRow->TreeOpts%41 == 0) CHECKED @endif autocomplete="off" class="mR5">
                    ...
                    @if ($GLOBALS["SL"]->sysHas('volunteers'))
                        <label class="disBlo mT20">
                            ...
                            @if ($GLOBALS['SL']->treeRow->TreeOpts%17 == 0) CHECKED @endif autocomplete="off" class="mR5">
                ...
                @if ($GLOBALS['SL']->treeRow->TreeType == 'Page')
                    <label class="disBlo mT20">
                        ...
                        @if ($GLOBALS['SL']->treeRow->TreeOpts%7 == 0) CHECKED @endif autocomplete="off" class="mR5">
                        <i class="fa fa-star mR5" aria-hidden="true"></i> Website Home Page
                    </label>
                    <label class="disBlo mT20">
                        <input type="checkbox" name="reportPage" id="reportPageID" value="13" 
                        @if ($GLOBALS['SL']->treeRow->TreeOpts%13 == 0) CHECKED @endif autocomplete="off" class="mR5" onClick="chkPageForTree();">
                        <i class="fa fa-list-alt mR5" aria-hidden="true"></i> Survey Report
                    </label>
                    <label class="disBlo mT20">
                        <input type="checkbox" name="searchPage" id="searchPageID" value="31" 
                        @if ($GLOBALS['SL']->treeRow->TreeOpts%31 == 0) CHECKED @endif autocomplete="off" class="mR5" onClick="chkPageForTree();">
                    ...
                    <select name="reportPageTree" id="reportPageTreeID" class="form-control mT5" 
                        autocomplete="off">
                        {!! $GLOBALS["SL"]->allTreeDropOpts($node->nodeRow->NodeResponseSet) !!}
                    </select>
                @else
                    <label class="disBlo red mT20">
                        <input type="checkbox" name="opts29" id="opts29ID" value="29" 
                            @if ($node->nodeRow->NodeOpts%29 == 0) CHECKED @endif 
                    ...
                    <label class="disBlo mT20">
                        <input type="checkbox" name="opts59" id="opts59ID" value="59" 
                            @if ($node->nodeRow->NodeOpts%59 == 0) CHECKED @endif 
                            autocomplete="off" class="mR5">
                        Hide Progress Bar
                    </label>
                @endif
                ...
                @if ($GLOBALS['SL']->treeRow->TreeType == 'Page')
                    ...
                    <label class="disBlo mT20">
                        <input type="checkbox" name="pageBg" id="pageBgID" value="67"
                            @if ($GLOBALS['SL']->treeRow->TreeOpts%67 == 0) CHECKED @endif autocomplete="off" class="mR5">
