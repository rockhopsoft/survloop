                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="checkbox-inline">
                            <label class="nobld">
                                <input type="checkbox" id="keyNon{{ $fldSfx }}" name="FldKeyType[]" value="Non" {{ $chkDis }} 
                        ...
                        <div class="checkbox-inline">
                            <label class="nobld">
                                <input type="checkbox" id="keyPri{{ $fldSfx }}" name="FldKeyType[]" value="Primary" {{ $chkDis }} 
                        ...
                        <div class="checkbox-inline">
                            <label class="nobld">
                                <input type="checkbox" id="keyFor{{ $fldSfx }}" name="FldKeyType[]" value="Foreign" {{ $chkDis }} id="keyFor{{ $fldSfx }}" 
                        ...
                        <div class="checkbox-inline">
                            <label class="nobld">
                                <input type="checkbox" id="keyAlt{{ $fldSfx }}" name="FldKeyType[]" value="Alternate" {{ $chkDis }} 
                                @if (strpos($fld->FldKeyType, 'Alternate') !== false) CHECKED @endif 
                                onClick="checkKey('{{ $fldSfx }}', 1);" > Alternate
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <fieldset class="form-group">
                    ...
                    @forelse ($defDeets as $set => $def)
                        <option value="{{ $set }}" @if ($defSet == $set) SELECTED @endif >{{ $set }} ({{ substr($def[0], 1, 15) }}...)</option>
                    @empty
                    @endforelse
                    </select>
                </fieldset>
