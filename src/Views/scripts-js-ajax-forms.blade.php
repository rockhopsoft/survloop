/* generated from resources/views/vendor/survloop/scripts-js-ajax-forms.blade.php */
    ...
    $(document).on("keyup", ".nFld input", function() { return tryCheckNodeUp($(this).attr("id")); });
    $(document).on("keyup", ".nFld textarea", function() { return tryCheckNodeUp($(this).attr("id")); });
    $(document).on("change", ".nFld select", function() { return tryCheckNodeUp($(this).attr("id")); });
    $(document).on("click", ".nFld input", function() { return tryCheckNodeUp($(this).attr("id")); });
