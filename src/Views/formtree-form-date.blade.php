...
<div class="timeWrap"><nobr>
    <select name="n{{ $nID }}fldMonth" id="n{{ $nID }}fldMonthID" onChange="formDateChange('{{ $nID }}');" 
        class="form-control input-lg  @if (isset($xtraClass)) {{ $xtraClass }} @endif fL mR5" style="width: 120px;"
        {!! $GLOBALS["SL"]->tabInd() !!}>
        ...
        class="form-control input-lg  @if (isset($xtraClass)) {{ $xtraClass }} @endif fL mR5 mL5" style="width: 70px;"
        {!! $GLOBALS["SL"]->tabInd() !!}>
        ...
        class="form-control input-lg  @if (isset($xtraClass)) {{ $xtraClass }} @endif fL mL5" style="width: 100px;"
        {!! $GLOBALS["SL"]->tabInd() !!}>
