...
class AdminDBController extends AdminController
{
    ...
    ******************************************************/
    ...
    protected function initExtra(Request $request)
    {
        ...
        $this->dbTitle = '<h1 class="disIn red">' . $GLOBALS["SL"]->dbRow->DbName . '&nbsp;</h1>';
        $this->dbSubTitle = '<span class="red">' . $GLOBALS["SL"]->dbRow->DbDesc . '</span>';
        $this->v["dbAllowEdits"] = ($this->v["user"] && $this->v["user"]->hasRole('administrator|databaser'));
        $this->v["mission"] = view('vendor.survloop.elements.inc-mission-statement', 
    ...
    ******************************************************/
    ...
    {
        return '<div class="pB10 pL20 mTn10">' . $GLOBALS["SL"]->dbRow->DbTables 
