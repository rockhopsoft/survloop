        ...
        $treeOut[] = $this->admMenuLnk(
            ...
            [
                $this->admMenuLnk(
                    ...
                    [
                        $this->admMenuLnk(
                            '/dashboard/settings/seo?ajax=1',
                            'Search Engines'
                        ),
                        $this->admMenuLnk(
                            '/dashboard/settings/colors?ajax=1',
                            'Colors & Logos'
                        ),
                        $this->admMenuLnk(
                            '/dashboard/settings/hard-code?ajax=1',
                            'Hard-Code HTML CSS JS'
                        ),
                        $this->admMenuLnk(
                            '/dashboard/settings/engine?ajax=1',
                            'Engine Settings'
                        )
                    ]
                ),
